...
arguments
    params.data_top_dir = ['C:\Users\Greg Milburn\Downloads\temp'];
    params.output_top_dir = ['C:\Users\Greg Milburn\Downloads\temp\analysis'];
...
%         trace_data.k_tr_r_sq(trace_counter) = k_tr_out.k_tr_r_sq;
        trace_data.pCa(trace_counter) = td.pCa;
        trace_data.force(trace_counter) = td.force(end);
